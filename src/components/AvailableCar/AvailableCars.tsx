...
const AvailableCars: React.FC = () => {
  ...
  // Mock car data array
  const carData = [
    { id: 1, startTime: '02:00 PM', endTime: '05:00 PM', duration: '3h 30Min', company: 'Yahoo Car', price: 4950, seatsLeft: 12 },
    { id: 2, startTime: '03:00 PM', endTime: '06:30 PM', duration: '3h 30Min', company: 'Alpha Car', price: 5000, seatsLeft: 10 },
    { id: 3, startTime: '04:00 PM', endTime: '07:30 PM', duration: '3h 30Min', company: 'Beta Car', price: 4800, seatsLeft: 8 },
    { id: 4, startTime: '05:00 PM', endTime: '08:30 PM', duration: '3h 30Min', company: 'Gamma Car', price: 5100, seatsLeft: 15 },
    { id: 5, startTime: '06:00 PM', endTime: '09:30 PM', duration: '3h 30Min', company: 'Delta Car', price: 4700, seatsLeft: 7 },
    { id: 6, startTime: '07:00 PM', endTime: '10:30 PM', duration: '3h 30Min', company: 'Epsilon Car', price: 5300, seatsLeft: 5 },
    { id: 7, startTime: '08:00 PM', endTime: '11:30 PM', duration: '3h 30Min', company: 'Zeta Car', price: 4900, seatsLeft: 4 },
  ...
  return (
    <div className="">
      ...
      <div className="h-auto  w-full border">
        <div className="p-3 mx-10 lg:mx-24 flex flex-wrap md:flex-row justify-between items-start lg:items-center">
          {/* Static search data */}
          {/* From */}
          <div>
          ...
          {/* Search Button */}
          <div>
            <button className="border border-primary p-2 rounded-lg shadow-lg text-primary">
              Search Again
            </button>
          </div>
        </div>
      ...
      <div className="mx-24 mt-5">
              ...
              <div className="flex justify-between relative">
                <div>
                  ...
                  <p>
                    ...
                    <span className="bg-forth rounded-2xl p-1 text-xs ml-3">Rwf</span>
                  </p>
        ...
        <div className="flex justify-center gap-3 mt-5">
          ...
          <button
            ...
            disabled={currentPage === Math.ceil(carData.length / carsPerPage)}
            className="p-2 bg-gray-200 rounded disabled:opacity-50"
          >
