...
const Footer = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <div className="h-auto bg-primary">
      <div className="h-auto text-white mx-10 md:mx-24 flex flex-col md:flex-row md:justify-between pt-5">
        <div>
          <img src={logo} alt="logo" className="h-12 sm:h-14 ml-2 bg-white" />
          <h1 className='text-2xl'>Travel Agency</h1>
          <p>Kigali-Rwanda</p>
          <p>07872****1/07299***3</p>
          <div className='bg-primary rounded-2xl flex p-5 w-56 justify-between'>
            <img src={fb} alt="fb" />
            <img src={x} alt="x" />
        ...
        <div>
          <p className='text-2xl'>For Clients</p>
          <p>About Us</p>
          <p>How it Works</p>
          <p>FAQs</p>
          <p>Contact</p>
