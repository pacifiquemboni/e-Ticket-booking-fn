  ...
  return (
    <>
      <div className="h-16 bg-primary flex items-center sticky top-0 z-50"> {/* Add sticky and z-index */}
        ...
        {profileOpen && (
          <div className='bg-primary absolute w-9/12 md:w-auto h-52 top-16 md:right-24 rounded-tl-2xl rounded-tr-2xl'>
        ...
        {menuOpen && (
          <div className="lg:hidden absolute flex flex-col right-0 top-16 items-center justify-between px-14 py-2 w-96 h-40  rounded space-y-2 bg-primary text-white">
            <a href="#">Home</a>
            <a onClick={scrollToAbout} className='cursor-pointer'>About</a>
            <a onClick={scrollToRoutes} className='cursor-pointer'>Routes</a>
            <a onClick={scrollToFaqs} className='cursor-pointer'>FAQs</a>
